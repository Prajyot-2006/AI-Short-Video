...
boolean}) => {
        ...
        const toggePublish = async (projectId:string)=> {
        ...
        return (
            <div key={gen.id} className="mb-4 break-inside-avoid">
                ...
                hover:border-white/20 transition group">
                        ...
                        {!forCommunity && (
                            ...
                            group-hover:opacity-100 transition flex items-center gap-2">
                                ...
                                <div className="flex flex-col items-end w-32 text-sm">
                                    ...
                                    <button onClick={()=> handleDelete(gen.id)}  className="w-full flex gap-2 items-center px-4
                                        py-2 hover:bg-red-950/10 text-red-400 cursor-pointer"  > 
                    ...
                    {/* details */}
                    <div className="p-4">
                        {/*product description , date , aspect ratio */}
                        ...
                        {!forCommunity && (
                            <div className="mt-4 grid grid-cols-2 gap-3" >
                                ...
                                <PrimaryButton onClick={()=> toggePublish(gen.id)}
