  ...
  return (
    <div className="relative group" >
      <div className={`relative h-64 rounded-2xl border-2
        ...
        items-center justify-center bg-white/2 p-6 ${file ? 'border-violet-600/50 bg-violet-500/5' : 'border-white/10 hover:border-violet-500/30 hover:bg-white/5' } `}>
        {file ? (
          <>
          ...
          <div className="absolute bottom-4 left-4 right-4 bg-black/50 background-blur-md p-3 rounded-lg border border-white/10">
